...
Feature: Journal Title Search Result Relevancy  (Stanford)
  ...
  Scenario: "Nature"
    ...
    And I should get at least 1 of these ckeys in the first 3 results: "3195844, 8721740"
    And I should get at least 2 of these ckeys in the first 5 results: "3195844, 8721740"
